 ...
 */
export declare type WrappedFunction<T> = (data: T, options?: ContextOptions) => any | Promise<any>;
...
export declare function wrapV1<T>(cloudFunction: CloudFunction<T>): WrappedScheduledFunction | WrappedFunction<T>;
